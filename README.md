...
https://github.com/DeqingSun/arduino_core_ch32/releases/download/initBinStorage/package_ch32v_index_release.json
...
- [CH573 EVT Boards](#CH573-EVT-Boards)
- [CH572 EVT Boards](#CH572-EVT-Boards)
...
You could file an issue on GitHub in this fork.
