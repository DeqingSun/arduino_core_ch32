...
void USB_EP0_SETUP() {
                     ...
                     USB_REQ_RECIP_ENDP) // endpoint
          {
            if ((((uint16_t)UsbSetupBuf->wValueH << 8) | UsbSetupBuf->wValueL) ==
              ...
              R8_UEP4_CTRL = R8_UEP4_CTRL & (~RB_UEP_T_TOG) |
                ...
                break;
              case 0x04:
              R8_UEP4_CTRL = R8_UEP4_CTRL & (~RB_UEP_R_TOG) |
                            UEP_R_RES_STALL; // Set endpoint4 OUT Stall
                break;
              case 0x83:
              R8_UEP3_CTRL = R8_UEP3_CTRL & (~RB_UEP_T_TOG) |
                            UEP_T_RES_STALL; // Set endpoint3 IN STALL
                break;
              case 0x03:
              R8_UEP3_CTRL = R8_UEP3_CTRL & (~RB_UEP_R_TOG) |
    ...
    if (len == 0xff) {
      SetupReq = 0xFF;
      R8_UEP0_CTRL =
          RB_UEP_R_TOG | RB_UEP_T_TOG | UEP_R_RES_STALL | UEP_T_RES_STALL; // STALL
    } else if (len <=
